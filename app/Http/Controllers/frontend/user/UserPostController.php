...
class UserPostController extends Controller
{
    ...
    {
        $posts = UserPost::where('user_id', Auth::id())->orderBy('id', 'desc')->get();
    ...
    {
        return view('frontend.user.posts.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('frontend.user.posts.show', compact('show'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('frontend.user.posts.edit', compact('edit'));
    }
